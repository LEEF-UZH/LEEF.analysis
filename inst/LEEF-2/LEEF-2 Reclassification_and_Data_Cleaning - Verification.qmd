...
params:
  arrow_dir: "/Volumes/RRD.Reclassification_LEEF-2/parquet_v2.3.7-LEEF-2_20230727"
...
options(RRDarrow = params$arrow_dir)
...
```{r}
missing_timestamps |>
    filter(measurement == "bemovi_mag_16") |>
...
```{r}
missing_timestamps |>
    filter(measurement == "bemovi_mag_25") |>
    select(measurement, missing_timestamps) |>
    distinct() |>
    arrange() |>
    knitr::kable()
...
```{r}
missing_timestamps |>
    filter(measurement == "bemovi_mag_25_cropped") |>
    select(measurement, missing_timestamps) |>
    distinct() |>
    arrange() |>
    knitr::kable()
