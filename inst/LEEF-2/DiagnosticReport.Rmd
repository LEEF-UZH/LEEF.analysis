...
Rscript -e "library(LEEF.analysis); db <- '~/Desktop/9.backend/LEEF.RRD.sqlite'; LEEF_2_report_diagnostic(db = 'DATABASE PATH',  format = 'html', lastDays = 7);"
```
...
```{r dens_species_b_16_raw, fig.height = 32}
...
```{r dens_species_b_25_raw, fig.height = 32}
LEEF_2_plot_density_species_per_bottle_per_timestamp(
  params$db, 
  transform_density_4throot = FALSE, 
...
```{r dens_species_b_25_non_crop_raw, fig.height = 32}
LEEF_2_plot_density_species_per_bottle_per_timestamp(
  params$db, 
  transform_density_4throot = FALSE, 
...
```{r dens_species_b_25_crop_raw, fig.height = 32}
LEEF_2_plot_density_species_per_bottle_per_timestamp(
  params$db, 
  transform_density_4throot = FALSE, 
...
### Flowcam Algae
```{r dens_species_fcam_al_raw, fig.height = 32}
LEEF_2_plot_density_species_per_bottle_per_timestamp(
  params$db, 
  transform_density_4throot = FALSE, 
  measurement = "flowcam",
...
### Flowcam Ciliates
```{r dens_species_fcam_cil_raw, fig.height = 32}
LEEF_2_plot_density_species_per_bottle_per_timestamp(
  params$db, 
  transform_density_4throot = FALSE, 
  measurement = "flowcam",
...
### Flowcam Rest
```{r dens_species_fcam_rest_raw, fig.height = 32}
LEEF_2_plot_density_species_per_bottle_per_timestamp(
  params$db, 
  transform_density_4throot = FALSE, 
  measurement = "flowcam",
...
### Flowcytometer
```{r dens_species_fcyt_raw, fig.height = 32}
LEEF_2_plot_density_species_per_bottle_per_timestamp(
  params$db, 
  transform_density_4throot = FALSE, 
...
### Manualcount
```{r dens_species_mc_raw, fig.height = 32}
LEEF_2_plot_density_species_per_bottle_per_timestamp(
  params$db, 
  transform_density_4throot = FALSE, 
...
```{r percent_o2_raw, fig.height = 32}
...
### Bemovi Magnification 16
```{r dens_species_b_16, fig.height = 32}
LEEF_2_plot_density_species_per_bottle_per_timestamp(
  params$db, 
...
### Bemovi Magnification 25
```{r dens_species_b_25, fig.height = 32}
LEEF_2_plot_density_species_per_bottle_per_timestamp(
  params$db, 
  transform_density_4throot = TRUE, 
  measurement = "bemovi_mag_25",
...
```{r dens_species_b_25_non_crop, fig.height = 32}
LEEF_2_plot_density_species_per_bottle_per_timestamp(
  params$db, 
  transform_density_4throot = TRUE, 
  measurement = "bemovi_mag_25_non_cropped",
...
### Bemovi Magnification 25 cropped
```{r dens_species_b_25_crop, fig.height = 32}
LEEF_2_plot_density_species_per_bottle_per_timestamp(
  params$db, 
  transform_density_4throot = TRUE, 
  measurement = "bemovi_mag_25_cropped",
...
### Flowcam Algae
```{r dens_species_fcam_al, fig.height = 32}
LEEF_2_plot_density_species_per_bottle_per_timestamp(
  params$db, 
  transform_density_4throot = TRUE, 
  measurement = "flowcam",
...
### Flowcam Ciliates
```{r dens_species_fcam_cil, fig.height = 32}
LEEF_2_plot_density_species_per_bottle_per_timestamp(
  params$db, 
  transform_density_4throot = TRUE, 
  measurement = "flowcam",
...
### Flowcam Rest
```{r dens_species_fcam_rest, fig.height = 32}
LEEF_2_plot_density_species_per_bottle_per_timestamp(
  params$db, 
  transform_density_4throot = TRUE, 
  measurement = "flowcam",
...
### Flowcytometer
```{r dens_species_fcyt, fig.height = 32}
LEEF_2_plot_density_species_per_bottle_per_timestamp(
  params$db, 
  transform_density_4throot = TRUE, 
  measurement = "flowcytometer",
...
### Manualcount
```{r dens_species_mc, fig.height = 32}
LEEF_2_plot_density_species_per_bottle_per_timestamp(
  params$db, 
  transform_density_4throot = TRUE, 
  measurement = "manualcount",
