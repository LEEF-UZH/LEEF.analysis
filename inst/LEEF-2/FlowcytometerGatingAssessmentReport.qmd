---
title: "Flowcytometer Gating Assessment Report"
format: 
  html:
    toc: true
    toc-location: left
...
execute:
  cache: false
params:
  db: "/Volumes/LEEF/0.RRD/LEEF-2.RRD.20221209.sqlite"
  extracted_dir: "~/Desktop/2.extracted.data/flowcytometer"
---
...
#| label: read_data
fsa <- list(
  readRDS(file.path(params$extracted_dir, "flowcytometer_fsa_ungated.p_1.rds")),
  readRDS(file.path(params$extracted_dir, "flowcytometer_fsa_ungated.p_2.rds"))
)  

gates <- list(
  readRDS(file.path(params$extracted_dir, "flowcytometer_gates.p_1.rds")),
  readRDS(file.path(params$extracted_dir, "flowcytometer_gates.p_2.rds"))
)
```
