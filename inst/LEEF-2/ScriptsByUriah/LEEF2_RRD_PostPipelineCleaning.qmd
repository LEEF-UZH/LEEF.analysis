...
new_densities <- rbind(morph25_density, morph25_cropped_density, morph16_density) %>% dplyr::select(-numberOfVideos)
...
new_densities <- rbind(morph25_density,morph16_density) %>%   dplyr::select(-numberOfVideos)
