...
parquet_dir <- file.path(params$output_dir, "parquet")
...
list.files(
    ...
    parquet_add_bemovi_16(path_to_parquet_root_dir = parquet_dir)
...
list.files(
    ...
    parquet_add_bemovi_25(path_to_parquet_root_dir = parquet_dir)
...
list.files(
    ...
    parquet_add_bemovi_25_cropped(path_to_parquet_root_dir = parquet_dir)
```
...
list.files(
    ...
    parquet_add_flowcam(path_to_parquet_root_dir = parquet_dir)
...
c(
    ...
    parquet_add_flowcytometer(path_to_parquet_root_dir = parquet_dir)
```
...
list.files(
    ...
    parquet_add_manualcount(path_to_parquet_root_dir = parquet_dir)
...
list.files(
    ...
    parquet_add_o2(path_to_parquet_root_dir = parquet_dir)
...
list.files(
    ...
    parquet_add_conductivity(path_to_parquet_root_dir = parquet_dir)
...
parquetize::csv_to_parquet(
    path_to_file = file.path(parameter_dir, "parameter", "00.general.parameter", "compositions.csv"),
...
parquetize::csv_to_parquet(
    path_to_file = file.path(parameter_dir, "parameter", "00.general.parameter", "experimental_design.csv"),
...
parquetize::csv_to_parquet(
    path_to_file = file.path(parameter_dir, "treatment", "stressor_levels.csv"),
...
LEEF_2_report_diagnostic(
    suffix = paste0("LEEF-2_reclassified_", params$version_tag), 
    format = "html",
    arrow = TRUE,
    parquet_dir = file.path(params$output_dir, "parquet")
)
