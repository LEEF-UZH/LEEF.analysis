...
```{r}
#| label: add_o2meter
#| eval: !expr params$update_parquet_o2meter
#| 
...
## experimental tables
unlink(file.path(path_to_parquet_root_dir, "composition"), recursive = TRUE, force = TRUE)
...
unlink(file.path(path_to_parquet_root_dir, "experimental_design"), recursive = TRUE, force = TRUE)
parquetize::csv_to_parquet(
