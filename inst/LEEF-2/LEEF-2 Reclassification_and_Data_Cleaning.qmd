...
parquet_add_flowcam(fns = fns, path_to_parquet_root_dir = parquet_dir, rename = FALSE)me = FALSE)
parquet_add_flowcam(fns = fns, path_to_parquet_root_dir = parquet_dir_renamed, rename = TRUE)ame = TRUE)
...
parquet_add_flowcytometer(path_to_parquet_root_dir = parquet_dir_renamed, rename = TRUE)ame = TRUE)
```
