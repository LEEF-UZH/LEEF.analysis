...
list.files(
    ...
    parquet_add_bemovi_25_cropped(path_to_parquet_root_dir = pd)
...
list.files(
    ...
    parquet_add_manualcount(path_to_parquet_root_dir = pd)
...
list.files(
    ...
    parquet_add_conductivity(path_to_parquet_root_dir = pd)
