    ...
    function(fn) {
        ...
        if ((fn_sp[[1]][1] == "mean_density_per_ml") & (fn_sp[[1]][2] >= 20230203)) {
            ...
            x <- x |>
                ...
                tibble::add_row(colp) |>
                group_by(timestamp, date, species, bottle, resources, temperature, salinity, magnification, sample, replicate) |>
...
LEEF_2_extract_traits_flowcytometer_archive(
    ...
    mc.cores = min(5, params$cores)
)

rm(timestamps)
```

### Remove bottles not needed in Flowcytometer
