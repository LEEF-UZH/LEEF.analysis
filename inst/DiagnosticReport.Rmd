...
date: | 
  | Last `timestamp`: `r LEEF.analysis::read_sql(params$db, sql = 'SELECT MAX(timestamp) FROM density')`
  | Sampling `day`: `r LEEF.analysis::read_sql(params$db, sql = 'SELECT MAX(day) FROM density')`
...
plot_bottles_per_timestamp(params$db, lastDays = 7)
```
