...
config <- file.path(pdir, "flowcam.yml")
download.file(
  "https://github.com/LEEF-UZH/LEEF.parameter/raw/Reclassification_1/parameter/flowcam/flowcam.yml", 
  destfile = config,
  mode = "wb"
)
species_tracked <- yaml::read_yaml(config)$species_tracked
rm(config)
```
...
config <- file.path(pdir, "bemovi.yml")
download.file(
