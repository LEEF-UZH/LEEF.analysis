  ...
  function(bemovi_dir){
    ...
    lapply(
      ...
      function(bemovi_config, bemovi_dir){
        ...
        dir.create(file.path( params$extracted_dir, bemovi_dir, bc$overlay.folder ), recursive = TRUE)
        
        temp_overlay_folder <- file.path( params$extracted_dir, bemovi_dir, bc$overlay.folder
