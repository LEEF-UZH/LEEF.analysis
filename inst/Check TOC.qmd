...
Fixed two typos. Now, it looks OK for me. 
...
## TOC plot from the Diagnostic Plots
Applying all the filters, the TOC Plots from the Diagnostic Plot lokk as folows:

```{r}
plot_tocs_per_bottle_per_timestamp(type = c("TC", "TOC"))
plot_tocs_per_bottle_per_timestamp(type = c("IC", "TN"))
```
