...
#### Densities UZH Samples
```{r}
#| label: flowcytometer_densities
#| 
...
#### Biomass EAWAG Samples

Now process the EAWAG samples. the previous ones will be replaced, if they exist.
```{r}
#| label: flowcytometer_biomass_EAWAG
#| 
...
toc <- readRDS(params$toc) %>%
  ...
  filter(!is.na(conc))
 params <- rmarkdown::yaml_front_matter()params
