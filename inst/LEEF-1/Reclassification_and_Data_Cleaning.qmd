...
# Create parquet
This is experimental. Te main storage is still the RRD sqlite database.
...
list.files(
  ...
  parquet_add_bemovi_16(path_to_parquet_root_dir = pd)
...
list.files(
    ...
    parquet_add_bemovi_25(path_to_parquet_root_dir = pd)
...
list.files(
    ...
    parquet_add_flowcam(path_to_parquet_root_dir = pd)
...
c(
    ...
    parquet_add_flowcytometer(path_to_parquet_root_dir = pd)
...
fns_o2 <- list.files(
    ...
    file.path("o2meter.csv") |>
    parquet_add_o2(path_to_parquet_root_dir = pd)
```