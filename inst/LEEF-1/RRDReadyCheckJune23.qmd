...
# options(RRDdb = "/Volumes/Macintosh HD/Users/uriah/Documents/1_Projects/LEEF_RRDs/LEEF1/LEEF.RRD.v1.8.5_final.sqlite")
options(RRDdb = "/Volumes/LEEF/RRD.Reclassification_final/LEEF.RRD.v1.8.5_final_vacuumed.sqlite")
...
water_chem <- db_read_table(table = "toc") %>% collect()
water_chem <- water_chem

water_chem <- water_chem %>%
  group_by(timestamp, day, type, 
           bottle, light_treatment, richness,
           composition, incubator) %>% 
  summarise(concentration = mean(concentration), 
            cv = as.numeric(NA), n = n()) %>% ungroup()
...
design_long <- design %>%
  pivot_longer(cols = -c(bottle,light_treatment,richness,composition,incubator), names_to = "species") %>%
