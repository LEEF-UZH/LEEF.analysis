...
db_org <- db
db_1 <- gsub(".sqlite", paste0(".", params$version_tag, ".1.sqlite"), db_org)
db_2 <- gsub(".sqlite", paste0(".", params$version_tag, ".2.sqlite"), db_org)
db_3 <- gsub(".sqlite", paste0(".", params$version_tag, ".3.sqlite"), db_org)
db_4 <- gsub(".sqlite", paste0(".", params$version_tag, ".4.sqlite"), db_org)
...
file.rename("tmp.4.sqlite", db_final)
```
