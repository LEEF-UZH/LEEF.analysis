...
## DONE - Regating of Flowcytometer
...
system.time(
  add_reclassified_to_db(
    ...
    method = c("flowcam", "bemovi_mag_16", "bemovi_mag_25", "flowcytometer")
  )
)
...
# 3. VERIFY - Set species to 0 which were mis-classified
