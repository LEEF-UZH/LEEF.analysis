...
```{r output_path}
db_path = "~/Desktop/RRD.Reclassification/"
dir.create(
  db_path,
  showWarnings = FALSE,
  recursive = TRUE
...
timestamps <- c(20210920, 20220105)
```
...
### `bemovi.mag.16/bemovi_extract.mag.16.yml`
```{r class_bemovi_16}
pdir <- tempfile()
dir.create(pdir, showWarnings = FALSE, recursive = TRUE)
...
class_constant <- file.path(pdir, "class_constant.rds")
download.file(
  "https://github.com/LEEF-UZH/LEEF.parameter/blob/Reclassification_1/parameter/bemovi.mag.16/svm_video_classifiers_18c_16x_december2021.rds", 
  destfile = class_constant,
  mode = "wb"
)
...
class_increasing <- file.path(pdir, "class_increasing.rds")
download.file(
  "https://github.com/LEEF-UZH/LEEF.parameter/blob/Reclassification_1/parameter/bemovi.mag.16/svm_video_classifiers_increasing_trained_at_18c_16x_december2021.rds", 
  destfile = class_increasing,
  mode = "wb"
)

bemovi_config <- file.path(pdir, "bemovi_extract.yml")
download.file(
  "https://raw.githubusercontent.com/LEEF-UZH/LEEF.parameter/Reclassification_1/parameter/bemovi.mag.16/bemovi_extract.mag.16.yml", 
  destfile = bemovi_config,
  mode = "wb"
)
system.time(
  LEEF.analysis::classify_bemovi_archive( 
    ...
    classifier_constant_name = class_constant, 
    classifier_increasing_name = class_increasing, 
    bemovi_extract_name = bemovi_config, 
    db_path = db_path
  )
)

unlink(bemovi_config)
```

### And clean everything up
```{r bemovi_16_clean}
unlink(pdir)
rm(pdir, class_constant, class_increasing, bemovi_config)
```
...
class_constant <- file.path(pdir, "class_constant.rds")
download.file(
  "https://github.com/LEEF-UZH/LEEF.parameter/blob/Reclassification_1/parameter/bemovi.mag.25/svm_video_classifiers_18c_25x_december2021.rds", 
  destfile = class_constant,
  mode = "wb"
)
...
bemovi_config <- file.path(pdir, "bemovi_extract.yml")
download.file(
  "https://github.com/LEEF-UZH/LEEF.parameter/raw/Reclassification_1/parameter/bemovi.mag.25/bemovi_extract.mag.25.yml", 
  destfile = bemovi_config,
  mode = "wb"
)
...
```{r class_bemovi_25_uncropped6}

download.file(
  "https://github.com/LEEF-UZH/LEEF.parameter/raw/Reclassification_1/parameter/bemovi.mag.25/bemovi_extract.mag.25.non_cropped.yml", 
  destfile = bemovi_config,
  mode = "wb"
)
...
### `bemovi_extract.mag.25.non_cropped.yml` 
```{r class_bemovi_25_cropped}

download.file(
  "https://github.com/LEEF-UZH/LEEF.parameter/raw/Reclassification_1/parameter/bemovi.mag.25/bemovi_extract.mag.25.cropped.yml", 
  destfile = bemovi_config,
  mode = "wb"
)
